...
module design_1_nes_apu_registers_0_0(Clk, Reset, CPU_Clk, CPU_M2, CPU_Rst, CPU_Addr, 
  CPU_Data, CPU_RomSel, CPU_RW, APU_Pulse1_Out, APU_Pulse2_Out, APU_Triangle_Out, 
  APU_Noise_Out, APU_DMC_Out, APU_Status_Out, APU_Counter_Out, Update)
/* synthesis syn_black_box black_box_pad_pin="Clk,Reset,CPU_Clk,CPU_M2,CPU_Rst,CPU_Addr[14:0],CPU_Data[7:0],CPU_RomSel,CPU_RW,APU_Pulse1_Out[31:0],APU_Pulse2_Out[31:0],APU_Triangle_Out[30:0],APU_Noise_Out[15:0],APU_DMC_Out[28:0],APU_Status_Out[6:0],APU_Counter_Out[1:0],Update" */;
  input Clk;
  input Reset;
  input CPU_Clk;
  input CPU_M2;
