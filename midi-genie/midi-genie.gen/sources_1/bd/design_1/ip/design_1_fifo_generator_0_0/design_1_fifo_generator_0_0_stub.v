...
/* synthesis syn_black_box black_box_pad_pin="clk,rst,din[25:0],wr_en,rd_en,dout[25:0],full,empty,data_count[9:0],wr_rst_busy,rd_rst_busy" */;
  input clk;
  input rst;
  input [25:0]din;
  input wr_en;
